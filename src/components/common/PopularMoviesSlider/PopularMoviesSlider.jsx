        ...
        <div className="flex overflow-hidden w-full h-screen">
            <div className="flex flex-row transition duration-500" style={style}>
                {moviesList.results ? moviesList.results.map(d =>
                    ...
                    >
                        <div className="flex md:flex-row md:justify-center sm:flex-col sm:items-center flex-col items-center">
                            <img
                            ...
                            />
                            <div className="flex flex-col justify-center items-center gap-4 sm:w-2/4">
                                <span className="text-white font-bold text-4xl sm:text-center">{d.original_title}</span>
                                <span className="text-white max-sm:hidden">{d.overview}</span>
                ...
                <div className="absolute w-full h-full flex justify-center items-center">
                    <div>
                        <button
                            ...
                            className="text-white text-4xl float-right">
                            <BsX />
                        </button>
                        <iframe
                            title="trailer"
